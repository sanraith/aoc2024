package hu.sanraith.aoc2024.cli
...
object FileManager:
  ...
  private val SourcePart = Paths.get("shared", "src", "main")
  private val NamespacePart =
    Paths.get("scala", "hu", "sanraith", "aoc2024")

  private val TemplateRoot = Paths.get("jvm", "src", "templates")
  ...
  private val TestRoot =
    Paths.get("jvm", "src", "test", NamespacePart.toString, "solution")
